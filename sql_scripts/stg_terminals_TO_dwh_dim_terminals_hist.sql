insert into de12.buma_dwh_dim_terminals_hist (terminal_id, terminal_type, terminal_city, terminal_address, start_dt, end_dt, deleted_flg)
select
	stg.terminal_id,
	stg.terminal_type,
	stg.terminal_city,
...
where buma_dwh_dim_terminals_hist.terminal_id = tmp.terminal_id
  and buma_dwh_dim_terminals_hist.end_dt = to_date('2999-12-31','YYYY-MM-DD');
insert into de12.buma_dwh_dim_terminals_hist (terminal_id, terminal_type, terminal_city, terminal_address, start_dt, end_dt, deleted_flg)
select
	stg.terminal_id,
	stg.terminal_type,
