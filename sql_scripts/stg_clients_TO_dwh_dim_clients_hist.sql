insert into de12.buma_dwh_dim_clients_hist (client_id, last_name, first_name, patronymic, date_of_birth, passport_num, passport_valid_to, phone, start_dt, end_dt, deleted_flg)
select
	stg.client_id,
	stg.last_name,
	stg.first_name,
...
where buma_dwh_dim_clients_hist.client_id = tmp.client_id
  and buma_dwh_dim_clients_hist.end_dt = to_date('2999-12-31','YYYY-MM-DD');
insert into de12.buma_dwh_dim_clients_hist (client_id, last_name, first_name, patronymic, date_of_birth, passport_num, passport_valid_to, phone, start_dt, end_dt, deleted_flg)
select
	stg.client_id,
	stg.last_name,
