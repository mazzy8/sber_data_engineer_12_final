insert into de12.buma_dwh_dim_accounts_hist (account_num, valid_to, client, start_dt, end_dt, deleted_flg)
select 
	stg.account , 
	stg.valid_to , 
	stg.client ,
...
where buma_dwh_dim_accounts_hist.account_num = tmp.account
  and buma_dwh_dim_accounts_hist.end_dt = to_date('2999-12-31','YYYY-MM-DD');
insert into de12.buma_dwh_dim_accounts_hist (account_num, valid_to, client, start_dt, end_dt, deleted_flg)
select
	stg.account,
	stg.valid_to,
